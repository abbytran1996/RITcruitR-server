...
namespace TMCS_Client.UI
{
    public class StudentRegistration : ContentPage
    {
        ...
        public StudentRegistration()
        {
            ...
            //Title
            registrationForm.Children.Add(lblTitle = new PageTitleLabel("Student Registration"),
            ...
            firstNameInput.Children.Add(lblFirstName = new FormFieldLabel("First Name"),
                                        new Rectangle(0.5, 0, 0.9, 0.5), AbsoluteLayoutFlags.All);

            firstNameInput.Children.Add(entFirstName = new FormEntry("First Name", Keyboard.Text),
            ...
            lastNameInput.Children.Add(lblLastName = new FormFieldLabel("Last Name"),
                                       new Rectangle(0.5, 0, 0.9, 0.5), AbsoluteLayoutFlags.All);

            lastNameInput.Children.Add(entLastName = new FormEntry("Last Name", Keyboard.Text),
                                       new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);

            entLastName.Completed += (object sender, EventArgs e) => entEmail.Focus();

            registrationForm.Children.Add(lastNameInput, 
                                          new Rectangle(0, 2.0 * Constants.Forms.Sizes.ROW_HEIGHT, 
                                                        1.0, Constants.Forms.Sizes.ROW_HEIGHT),
                                          AbsoluteLayoutFlags.WidthProportional);
            ...
            emailInput.Children.Add(lblEmail = new FormFieldLabel("Email"),
                                       new Rectangle(0.5, 0, 0.9, 0.5), AbsoluteLayoutFlags.All);

            emailInput.Children.Add(entEmail = new FormEntry("Email", Keyboard.Email),
                                    new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            ...
            registrationForm.Children.Add(emailInput, 
                                          new Rectangle(0, 3.0 * Constants.Forms.Sizes.ROW_HEIGHT, 
                                                        1.0, Constants.Forms.Sizes.ROW_HEIGHT),
                                          AbsoluteLayoutFlags.WidthProportional);
            ...
            passwordInput.Children.Add(lblPassword = new FormFieldLabel("Password"),
                                       new Rectangle(0.5, 0, 0.9, 0.5), AbsoluteLayoutFlags.All);

            passwordInput.Children.Add(entPassword = new FormEntry("Password", Keyboard.Text, true),
                                       new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            ...
            registrationForm.Children.Add(passwordInput, 
                                          new Rectangle(0, 4.0 * Constants.Forms.Sizes.ROW_HEIGHT, 
                                                        1.0, Constants.Forms.Sizes.ROW_HEIGHT),
                                          AbsoluteLayoutFlags.WidthProportional);
            ...
            retypePasswordInput.Children.Add(lblRetypePassword = new FormFieldLabel("Retype Password"), 
                                             new Rectangle(0.5, 0, 0.9, 0.5), AbsoluteLayoutFlags.All);

            retypePasswordInput.Children.Add(entRetypePassword = new FormEntry("Retype Password", Keyboard.Text, true), 
                                             new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            ...
            registrationForm.Children.Add(retypePasswordInput, 
                                          new Rectangle(0, 5.0 * Constants.Forms.Sizes.ROW_HEIGHT, 
                                                        1.0, Constants.Forms.Sizes.ROW_HEIGHT),
                                          AbsoluteLayoutFlags.WidthProportional);
            ...
            schoolNameInput.Children.Add(lblSchoolName = new FormFieldLabel("School Name"), 
                                         new Rectangle(0.5, 0, 0.9, 0.5), AbsoluteLayoutFlags.All);

            schoolNameInput.Children.Add(entSchoolName = new FormEntry("School Name", Keyboard.Text), 
                                         new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);

            entSchoolName.Completed += (object sender, EventArgs e) => entGraduationDate.Focus();

            registrationForm.Children.Add(schoolNameInput, 
                                          new Rectangle(0, 6.0 * Constants.Forms.Sizes.ROW_HEIGHT, 
                                                        1.0, Constants.Forms.Sizes.ROW_HEIGHT),
                                          AbsoluteLayoutFlags.WidthProportional);
            ...
            graduationDateInput.Children.Add(lblGraduationDate = new FormFieldLabel("Graduation Date"), 
                                             new Rectangle(0.5, 0, 0.9, 0.5), AbsoluteLayoutFlags.All);

            graduationDateInput.Children.Add(entGraduationDate = new FormEntry("mm/yy", Keyboard.Numeric), 
                                             new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            ...
            registrationForm.Children.Add(graduationDateInput, 
                                          new Rectangle(0, 7.0 * Constants.Forms.Sizes.ROW_HEIGHT, 
                                                        1.0, Constants.Forms.Sizes.ROW_HEIGHT), 
                                          AbsoluteLayoutFlags.WidthProportional);
            ...
            phoneNumberInput.Children.Add(lblPhoneNumber = new FormFieldLabel("Phone Number (Optional)"), 
                                          new Rectangle(0.5, 0, 0.9, 0.5), AbsoluteLayoutFlags.All);

            phoneNumberInput.Children.Add(entPhoneNumber = new FormEntry("(xxx) xxx-xxxx", Keyboard.Numeric), 
                                          new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            ...
            registrationForm.Children.Add(phoneNumberInput, 
                                          new Rectangle(0, 8.0 * Constants.Forms.Sizes.ROW_HEIGHT, 
                                                        1.0, Constants.Forms.Sizes.ROW_HEIGHT),
                                          AbsoluteLayoutFlags.WidthProportional);
            ...
            registrationForm.Children.Add(preferredLocationInput, 
                                          new Rectangle(0, 9.0 * Constants.Forms.Sizes.ROW_HEIGHT, 
                                                        1.0, Constants.Forms.Sizes.ROW_HEIGHT),
                                          AbsoluteLayoutFlags.WidthProportional);
            ...
            preferredCompanySizeInput.Children.Add(pickPreferredCompanySize = new CompanySizePicker(), 
                                                   new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);

            registrationForm.Children.Add(preferredCompanySizeInput, 
                                          new Rectangle(0, 10.0 * Constants.Forms.Sizes.ROW_HEIGHT, 
                                                        1.0, Constants.Forms.Sizes.ROW_HEIGHT),
                                          AbsoluteLayoutFlags.WidthProportional);
            ...
            resumeUpload.Children.Add(resumeUploadEntrySection, new Rectangle(0.5, 1.0, 0.9, 0.5), 
                                      AbsoluteLayoutFlags.All);

            registrationForm.Children.Add(resumeUpload, 
                                          new Rectangle(0, 11.0 * Constants.Forms.Sizes.ROW_HEIGHT, 
                                                        1.0, Constants.Forms.Sizes.ROW_HEIGHT),
                                          AbsoluteLayoutFlags.WidthProportional);
            ...
            registrationForm.Children.Add(btnRegister, 
                                          new Rectangle(0.5, ((12.0 * Constants.Forms.Sizes.ROW_HEIGHT) + 10.0), 
        ...
        private void register()
        {
            ...
            else
            {
                NewStudent newStudent = NewStudent.createAndValidate(
                    ...
                    entEmail.Text,
                    entSchoolName.Text,
                    entGraduationDate.Text.Length < 5 ? "0" + entGraduationDate.Text : entGraduationDate.Text,
                ...
                try
                {
                    (Application.Current as App).CurrentStudent = 
