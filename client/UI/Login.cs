    ...
    public class Login : ContentPage
    {
        ...
        private Login()
        {
            ...
            sectionRegister.Children.Add(new Label()
            {
                ...
                HorizontalTextAlignment = TextAlignment.Center,
            }, new Rectangle(0, 0, 1.0, 0.1), AbsoluteLayoutFlags.All);
            ...
            }, new Rectangle(0.5, 0.2, 0.25, 0.25), AbsoluteLayoutFlags.All);

            AbsoluteLayout pageContent = new AbsoluteLayout() { };

            pageContent.Children.Add(lblTitle, new Rectangle(0, 0, 1.0, 0.2), AbsoluteLayoutFlags.All);
            pageContent.Children.Add(sectionLogin, new Rectangle(0, 0.4, 1.0, 0.5), AbsoluteLayoutFlags.All);
            pageContent.Children.Add(sectionRegister, new Rectangle(0, 1.0, 1.0, 0.3), AbsoluteLayoutFlags.All);
            pageContent.Children.Add(loginBusyIndicator = new ActivityIndicator(), new Rectangle(0, 0, 1.0, 1.0), 
                                     AbsoluteLayoutFlags.All);
