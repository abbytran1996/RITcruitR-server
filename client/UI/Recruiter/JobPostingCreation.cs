...
namespace TMCS_Client.UI
{
    public class JobPostingCreation : ContentPage
    {
        ...
        public JobPostingCreation(Recruiter associatedRecruiter)
        {
            ...
            creationForm.Children.Add(lblTitle, new Rectangle(0.0, 0.0, 1.0, Constants.Forms.Sizes.ROW_HEIGHT), 
            ...
            positionNameSection.Children.Add(lblPositionTitle = new FormFieldLabel("Position Name"), 
                                             new Rectangle(0.5, 0.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            positionNameSection.Children.Add(entPositionTitle = new FormEntry("Position Name", Keyboard.Plain), 
            ...
            descriptionSection.Children.Add(lblDescription = new FormFieldLabel("Position Description"),
                                            new Rectangle(0.5, 0.0, 0.9, 1.0 / 6.0), AbsoluteLayoutFlags.All);
            descriptionSection.Children.Add(editorDescription = new FormEditor(), 
                                            new Rectangle(0.5, 1.0, 0.9, 5.0 / 6.0), AbsoluteLayoutFlags.All);
            ...
            importantSkillsSearchResults = 
                new FormSearchResultsListView<Skill, SkillSearchResultCell, SkillListCell>(importantSkills);
            importantSkillsSearchBar = 
                new FormSearchBar<Skill, SkillSearchResultCell, SkillListCell>("Search for required skills", allSkills, 
                                                                               importantSkillsSearchResults);
            ...
            nicetohaveSkillsSearchResults = 
                new FormSearchResultsListView<Skill, SkillSearchResultCell, SkillListCell>(nicetohaveSkills);
            nicetohaveSkillsSearchBar = new FormSearchBar<Skill, SkillSearchResultCell, SkillListCell>(
                "Search for recommended skills", allSkills, nicetohaveSkillsSearchResults);
            ...
            matchThresholdSection.Children.Add(lblMatchThreshold = new FormFieldLabel("Match Threshold"),
            ...
            locationSection.Children.Add(lblLocation = new FormFieldLabel("Position Location"),
                                         new Rectangle(0.5, 0.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            locationSection.Children.Add(entLocation = new FormEntry("Position Location", Keyboard.Plain),
                                         new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            ...
            phaseTimeoutSection.Children.Add(lblPhaseTimeout = new FormFieldLabel("Phase Timeout"),
                                             new Rectangle(0.5, 0.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            phaseTimeoutSection.Children.Add(entPhaseTimeout = new FormEntry("Days", Keyboard.Numeric),
                                             new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            ...
            problemStatementSection.Children.Add(lblProblemStatement = new FormFieldLabel("Problem Statement"),
                                                 new Rectangle(0.5, 0.0, 0.9, 1.0 / 6.0), AbsoluteLayoutFlags.All);
            problemStatementSection.Children.Add(editorProblemStatement = new FormEditor(),
                                                 new Rectangle(0.5, 1.0, 0.9, 5.0 / 6.0), AbsoluteLayoutFlags.All);
            ...
            webpageURLSection.Children.Add(lblWebpageURL = new FormFieldLabel("Webpage URL"),
                                           new Rectangle(0.5, 0.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            webpageURLSection.Children.Add(entWebpageURL = new FormEntry("Webpage URL", Keyboard.Url),
                                           new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            ...
            creationForm.Children.Add(btnCreate,
                                      new Rectangle(0.5, ((24 * Constants.Forms.Sizes.ROW_HEIGHT) + 10.0), 0.8, 
