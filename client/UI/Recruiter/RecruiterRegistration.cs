...
namespace TMCS_Client.UI
{
    public class RecruiterRegistration : ContentPage
    {
        ...
        public RecruiterRegistration(string title = "Recruiter Registration")
        {
            ...
            //Title
            registrationForm.Children.Add(lblTitle = new PageTitleLabel("Recruiter Registration"),
            ...
            firstNameInput.Children.Add(txtFirstName = new FormEntry("First Name", Keyboard.Text),
            ...
            emailInput.Children.Add(lblCompanyEmail = new FormFieldLabel("Company Email"),
                                    new Rectangle(0.5, 0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            emailInput.Children.Add(txtCompanyEmail = new FormEntry("Company Email", Keyboard.Email),
                                    new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            ...
            passwordInput.Children.Add(lblPassword = new FormFieldLabel("Password"),
                                       new Rectangle(0.5, 0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            passwordInput.Children.Add(txtPassword = new FormEntry("Password", Keyboard.Text, true),
                                       new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            ...
            retypePasswordInput.Children.Add(lblRetypePassword = new FormFieldLabel("Retype Password"),
                                             new Rectangle(0.5, 0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            retypePasswordInput.Children.Add(txtRetypePassword = new FormEntry("Retype Password", Keyboard.Text, true),
                                             new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            ...
            phoneNumberInput.Children.Add(lblPhoneNumber = new FormFieldLabel("Phone Number (Optional)"),
                                          new Rectangle(0.5, 0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            phoneNumberInput.Children.Add(txtPhoneNumber = new FormEntry("(xxx) xxx-xxxx", Keyboard.Numeric),
                                          new Rectangle(0.5, 1.0, 0.9, 0.5), AbsoluteLayoutFlags.All);
            ...
            registrationForm.Children.Add(btnRegister,
                                          new Rectangle(0.5, 8 * Constants.Forms.Sizes.ROW_HEIGHT + 20, 
        ...
        private async void register()
        {
            ...
            if(!SuffixCheck().Result)
            {
                ...
                var ans = await DisplayAlert("Your Company Email Does Not Match Any Company In Our Records.", 
                                             "Would You Like To Register A New Company", "Yes", "No");
                if(ans == true)
                {
            ...
            else
            {
                ...
                NewRecruiter newRecruiter = NewRecruiter.CreateAndValidate(
                    ...
                    company,
                    txtPhoneNumber.Text.Replace("(", "").Replace(")", "").Replace(" ", "").Replace("-", ""),
                    txtPassword.Text,
