...
namespace TMCS_Client.UI
{
    public class RecruiterProblemResponses : ContentPage
    {
        ...
        public RecruiterProblemResponses(JobPosting jobPosting)
        {
            ...
            promptSection.Children.Add(lblPromptField, new Rectangle(0.5, 0.0, 0.9, 0.3), AbsoluteLayoutFlags.All);
            lblPrompt = new Label()
            {
                Text = jobPosting.problemStatement,
                FontSize = 14.0,
            };
            promptSection.Children.Add(lblPrompt, new Rectangle(0.5, 1.0, 0.9, 0.7), AbsoluteLayoutFlags.All);

            pageContent.Children.Add(promptSection, new Rectangle(1.0, 0.0, 1.0, 0.2), AbsoluteLayoutFlags.All);
            ...
            problemResponseSection.Children.Add(lblResponseList, new Rectangle(0.5, 0.0, 0.9, 0.075),
            ...
            problemResponseSection.Children.Add(problemResponseList, new Rectangle(0.5, 1.0, 1.0, 0.925),
                                                AbsoluteLayoutFlags.All);
            
            pageContent.Children.Add(problemResponseSection, new Rectangle(0.0, 1.0, 1.0, 0.8),
                                     AbsoluteLayoutFlags.All);
