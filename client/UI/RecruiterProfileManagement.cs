...
{
    public class RecruiterProfileManagement : ContentPage
	{
		//Whole Page
		private ScrollView pageContent;
        private AbsoluteLayout profileManagementPage;
		...
		public RecruiterProfileManagement()
		{
			this.Title = "Recruiter Profile Management";
			...
			profileManagementPage = new AbsoluteLayout()
			{
			...
			//Title
			profileManagementPage.Children.Add(lblTitle =
										  new PageTitleLabel("Recruiter Profile Management"),
			...
			profileManagementPage.Children.Add(firstNameInput,
			...
			profileManagementPage.Children.Add(lastNameInput,
            ...
            profileManagementPage.Children.Add(emailInput,
			...
			profileManagementPage.Children.Add(passwordInput,
			...
			profileManagementPage.Children.Add(retypePasswordInput,
			...
			profileManagementPage.Children.Add(companyNameInput,
			...
			profileManagementPage.Children.Add(phoneNumberInput,
